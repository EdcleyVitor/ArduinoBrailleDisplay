        ...
        child: ListView(
          ...
          children: [
            _buildInfoCard(
              ...
              children: [
                _infoRow('Versao', '9.0.0'),
                _infoRow('Plataforma', 'ESP32 + Flutter'),
                _infoRow('Protocolo', 'BLE (Nordic UART Service) + Multi-Dispositivo'),
              ],
            ),
            ...
            _buildInfoCard(
              ...
              children: [
                ...
                _infoRow('Assinatura', 'WhatGodWrought1844'),
              ],
            ),
            const SizedBox(height: 16),
            _buildInfoCard(
              ...
              children: [
                ...
                _infoRow('Preferencias', 'Preferences (ESP32)'),
              ],
            ),
            const SizedBox(height: 16),
            SizedBox(
