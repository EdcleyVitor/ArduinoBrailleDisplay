...
class SettingsManager extends ChangeNotifier {
  ...
  bool get conectarMultiplos => _conectarMultiplos;
  ...
  Future<void> loadAll() async {
    ...
    final conectarMultiplos = await db.getSettingBool('conectarMultiplos', defaultValue: true);
    ...
    _conectarMultiplos = conectarMultiplos;
    _loaded = true;
    notifyListeners();
  }
  ...
  Future<void> setConectarMultiplos(bool value) async {
    _conectarMultiplos = value;
    await DatabaseHelper.instance.saveSettingBool('conectarMultiplos', value);
    notifyListeners();
  }
}
